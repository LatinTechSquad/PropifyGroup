		...
		<div className="bg-[#B595DB] rounded-2xl relative w-2/3 p-4">
			<div className="px-10">
				...
				<div className="grid grid-cols-12">
					<div className="col-span-6 flex flex-col gap-3 py-8">
						<span className="icon-description">
							<Image src={locationImg} width={35} height={35} alt="" className="object-cover" />
							{location}
						</span>
						<span className="icon-description">
							<Image src={m2Img} width={35} height={35} alt="" className="object-cover" />
							{info}
						</span>
						<span className="icon-description">
							<Image src={batImg} width={35} height={35} alt="" className="object-cover" />
							{bat}
						</span>
					</div>
				...
				<div className="flex items-center absolute" style={imageContainer}>
					<Image src={image} width={400} height={400} alt="" className="object-cover" />
				</div>
			</div>
		</div>
	);
