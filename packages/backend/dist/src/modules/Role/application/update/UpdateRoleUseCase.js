...
let UpdateRoleUseCase = class UpdateRoleUseCase {
    ...
    run(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const role = yield this._repository.getById(req.id);
            if (role === null)
                throw new RoleIdNotExistError_1.RoleIdNotExistError();
            role.updateFields(new RoleName_1.RoleName(req.roleName), new RoleState_1.RoleState(req.roleState));
            yield this._repository.update(role);
        });
    }
};
